...
input_file = 'metadata_dspace_test_02-12-2025.csv'
output_file = './matching_test/dspace_test_sample.csv'
authors_json_file = './matching_test/matched_authors/updated_merged_authors_all.json'
...
with open(authors_json_file, encoding="utf-8") as f:
...
df_filtered = df[df.apply(publication_is_valid, axis=1)]
...
for doc_type in doc_types:
    ...
    if sample_size > 0:
        sampled = type_df.sample(n=sample_size, random_state=10)
